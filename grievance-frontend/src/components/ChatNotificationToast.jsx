...
const SafeMessageCircleIcon = (props) => (
  typeof MessageCircleIcon === "function" ? (
    ...
    <svg width={props.width || "14"} height={props.height || "14"} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          >
            <SafeMessageCircleIcon width="14" height="14" />
          </span>
          <div>
