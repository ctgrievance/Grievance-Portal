...
export const SendIcon = (props) => (
    <svg {...defaultProps} width="18" height="18" {...props}>
...
export const StudentIcon = (props) => (
    <svg {...defaultProps} width="32" height="32" {...props}>
...
export const BookIcon = (props) => (
    <svg {...defaultProps} {...props}>
        <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20v2H6.5A2.5 2.5 0 0 1 4 19.5z" />
        <path d="M4 7v5h16V7H4z" />
        <path d="M18 17H6.5C4 17 4 14.5 4 14.5V7a3 3 0 0 1 3-3h10a3 3 0 0 1 3 3v7.5c0 0 .1 2.5-2.5 2.5z" />
    </svg>
);
...
export const RerouteIcon = (props) => (
    <svg {...defaultProps} {...props}>
...
export const StarIcon = (props) => (
    <svg {...defaultProps} fill="currentColor" stroke="currentColor" {...props}>
