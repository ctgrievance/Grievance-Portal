...
export default function RecordsComparisonTab() {
  ...
  return (
    <div style={{ width: "100%", animation: "fadeIn 0.2s ease" }}>
        ...
        >
          <button
            ...
            style={{
              ...
              color: cohort === "students" ? "#2563eb" : "#64748b",
              boxShadow: cohort === "students" ? "0 2px 6px rgba(0, 0, 0, 0.08)" : "none",
          ...
          <button
            ...
            style={{
              ...
              color: cohort === "staff" ? "#2563eb" : "#64748b",
              boxShadow: cohort === "staff" ? "0 2px 6px rgba(0, 0, 0, 0.08)" : "none",
              transition: "all 0.2s ease"
            }}
          >
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: "0.75rem", color: "#94a3b8" }}>
            Official university validation dataset
          </span>
        </div>
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <span style={{ background: "#dcfce7", color: "#15803d", fontSize: "0.72rem", fontWeight: 700, padding: "2px 8px", borderRadius: "999px" }}>
          ...
          <span style={{ fontSize: "0.75rem", color: "#16a34a" }}>
            Active accounts with verified OTP
          </span>
        </div>
        ...
        >
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <span style={{ fontSize: "0.75rem", fontWeight: 700, color: "#e11d48", textTransform: "uppercase", letterSpacing: "0.04em" }}>
              Not Registered Yet
            </span>
            <span style={{ background: "#ffe4e6", color: "#be123c", fontSize: "0.72rem", fontWeight: 700, padding: "2px 8px", borderRadius: "999px" }}>
        ...
        >
          ...
          <span style={{ fontSize: "0.72rem", color: "#64748b", marginTop: "8px" }}>
      ...
      <div className="reg-users-filters-bar" style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap", padding: "14px 18px" }}>
        ...
        <div style={{ display: "flex", gap: "8px", flexWrap: "wrap", alignItems: "center" }}>
          <button
            ...
            style={{
              ...
              color: statusFilter === "all" ? "#1d4ed8" : "#475569",
              fontSize: "0.82rem",
          ...
          >
            ...
            <span style={{ background: statusFilter === "all" ? "#bfdbfe" : "#f1f5f9", padding: "1px 6px", borderRadius: "10px", fontSize: "0.72rem" }}>
              {summary.totalRecords.toLocaleString()}
            </span>
          </button>
          ...
          >
            ...
            <span style={{ background: statusFilter === "registered" ? "#a7f3d0" : "#f1f5f9", padding: "1px 6px", borderRadius: "10px", fontSize: "0.72rem", color: "#065f46" }}>
              {summary.totalRegistered.toLocaleString()}
            </span>
          </button>
          ...
          >
            ...
            <span>Not Registered Only</span>
            <span style={{ background: statusFilter === "not_registered" ? "#fecdd3" : "#f1f5f9", padding: "1px 6px", borderRadius: "10px", fontSize: "0.72rem", color: "#9f1239" }}>
              {summary.totalNotRegistered.toLocaleString()}
            </span>
          </button>
        </div>
        ...
        {/* Search Box */}
        <div className="reg-users-search-box" style={{ maxWidth: "280px" }}>
        ...
        {departmentsList.length > 0 && (
          <div className="reg-users-select-wrap dept" style={{ width: "170px" }}>
            <select
      ...
      <div style={{ background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: "12px", overflow: "hidden", boxShadow: "0 1px 3px rgba(0,0,0,0.02)" }}>
        {loading ? (
          <div style={{ padding: "48px 20px", textAlign: "center", color: "#64748b" }}>
            ...
            <p style={{ margin: 0, fontWeight: 600 }}>Comparing master records against registered accounts...</p>
          </div>
        ) : records.length === 0 ? (
          <div style={{ padding: "48px 20px", textAlign: "center", color: "#64748b" }}>
            <div style={{ fontSize: "2rem", marginBottom: "8px" }}>🔍</div>
            <p style={{ margin: 0, fontWeight: 700, color: "#1e293b", fontSize: "1.05rem" }}>No matching records found</p>
          ...
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left", fontSize: "0.86rem" }}>
              <thead>
                <tr style={{ background: "#f8fafc", borderBottom: "1.5px solid #e2e8f0", color: "#475569", textTransform: "uppercase", fontSize: "0.72rem", letterSpacing: "0.04em", fontWeight: 700 }}>
                  <th style={{ padding: "12px 16px" }}>#</th>
                  <th style={{ padding: "12px 16px" }}>{cohort === "students" ? "Student ID / CTU ID" : "Staff ID"}</th>
                  <th style={{ padding: "12px 16px" }}>Official Details</th>
                  <th style={{ padding: "12px 16px" }}>{cohort === "students" ? "School / Program" : "Department / Role"}</th>
                  <th style={{ padding: "12px 16px", textAlign: "center" }}>Portal Status</th>
                  <th style={{ padding: "12px 16px" }}>Registered Account Info</th>
                </tr>
              </thead>
              <tbody>
                {records.map((rec, index) => {
                  ...
                  return (
                    ...
                    >
                      {/* S.No */}
                      <td style={{ padding: "12px 16px", color: "#94a3b8", fontSize: "0.78rem", fontWeight: 600 }}>
                        {rowNum}
                      </td>
                      ...
                      <td style={{ padding: "12px 16px" }}>
                        ...
                        <div style={{ display: "flex", gap: "10px", fontSize: "0.76rem", color: "#64748b", marginTop: "3px", flexWrap: "wrap" }}>
                          {rec.email && (
