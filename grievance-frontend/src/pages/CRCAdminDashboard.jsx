...
function CRCAdminDashboard() {
  ...
  useEffect(() => {
    // ✅ Security Check: Agar banda CRC ka admin nahi hai, toh bhaga do
    if (adminDept !== "CRC (Placement)") {
  ...
  const fetchGrievances = async () => {
    try {
      ...
      const category = encodeURIComponent("CRC (Placement)");
    ...
    <div className="dashboard-container">
      <header className="dashboard-header admin-dashboard-header">
        ...
        <div className="admin-header-actions">
          <ProfileHeaderButton />
          <DepartmentSwitcher currentDepartment="CRC (Placement)" />
...
export default CRCAdminDashboard;