...
function AccountAdminDashboard() {
  ...
  useEffect(() => {
    ...
    const isAuthorized = isMasterAdmin || // Master
    ...
    <div className="dashboard-container">
      <header className="dashboard-header admin-dashboard-header">
          ...
          <div className="header-content">
            ...
            <p className="admin-header-user-info">
              ...
              <span className="admin-master-badge">
                <ShieldIcon width="12" height="12" /> Accounts
              </span>
            </p>
          </div>
        </div>
        <div className="admin-header-actions">
          <ProfileHeaderButton />
          <DepartmentSwitcher currentDepartment="Accounts" />
          ...
          {filteredGrievances.length === 0 ? (
            ...
            <div className="table-container">
              <table className="grievance-table">
                <thead><tr><th>Student ID</th><th>Name</th><th>Message</th><th>Assigned To</th><th>Deadline</th><th>Status</th><th>Action</th></tr></thead>
                <tbody>
