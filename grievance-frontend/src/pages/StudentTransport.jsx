  ...
  const [isSubmitting, setIsSubmitting] = useState(false);
    ...
    useEffect(() => {
        const fetchIssueTypes = async () => {
            try {
                const res = await fetch(`${process.env.REACT_APP_API_URL || "http://localhost:5000"}/api/issue-types/department/Transport`);
                if (!res.ok) {
    ...
    setIsSubmitting(true);
        ...
        // Upload File to MongoDB (GridFS) First
        let attachmentUrl = "";
        if (attachment) {
        ...
        <div className="dashboard-container">
            ...
            <nav className="navbar">
                <ul>
                    ...
                    <li className="active"><Link to="/student/transport">Transport</Link></li>
                </ul>
            </nav>

            <main className="dashboard-body">
                <div className="card">
                    <h2>Submit Transport Grievance</h2>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="input-group">
                                ...
                                <textarea
                                    ...
                                    rows="4"
                                    placeholder="Describe your transport-related issue (e.g., bus route, timing, driver behavior, etc.)..."
                                    required
                                />
                            </div>
