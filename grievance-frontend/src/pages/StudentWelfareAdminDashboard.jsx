...
function StudentWelfareAdminDashboard() {
  ...
  const { allowStudentRecords, allowStaffRecords } = useDepartmentPermissions("Student Welfare");
  ...
  return (
    <div className="dashboard-container">
      ...
      <nav className="navbar">
        <ul>
          <li className="admin-nav-title"><span>Student Welfare</span></li>
          ...
          <li><SmartAssignmentNavLink department="Student Welfare" /></li>
        </ul>
      </nav>
