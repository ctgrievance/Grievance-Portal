...
function TransportAdminDashboard() {
    ...
    const { allowStudentRecords, allowStaffRecords } = useDepartmentPermissions("Transport");
    ...
    const fetchGrievances = async () => {
        try {
            ...
            const category = encodeURIComponent("Transport");
    ...
    const handleExportSelected = (selectedData, selectedColumns) => {
        ...
        fetch(`${process.env.REACT_APP_API_URL || "http://localhost:5000"}/api/grievances/export-selected`, {
            ...
            .then((blob) => {
                ...
                a.href = url; a.download = `transport_grievances_${new Date().toISOString().split('T')[0]}.xlsx`;
  ...
  return (
    <div className="dashboard-container">
                    ...
                    <div className="header-content">
                        ...
                        <p>
                            ...
                            <span className="status-badge status-assigned" style={{ marginLeft: '10px', fontSize: '0.8rem', display: 'inline-flex', alignItems: 'center', gap: '5px' }}>
                                <ShieldIcon width="14" height="14" /> Transport
                            </span>
                        </p>
                    </div>
                    <ProfileHeaderButton />
            ...
            <nav className="navbar">
                <ul>
                    <li className="admin-nav-title"><span>Transport</span></li>
                    ...
                    <li><SmartAssignmentNavLink department="Transport" /></li>
                </ul>
            </nav>
