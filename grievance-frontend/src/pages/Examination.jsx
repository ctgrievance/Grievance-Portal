...
function Examination() {
  ...
  useEffect(() => {
    const fetchIssueTypes = async () => {
      try {
        const res = await fetch(`${process.env.REACT_APP_API_URL || "http://localhost:5000"}/api/issue-types/department/Examination`);
        if (!res.ok) {
  ...
  return (
    <div className="dashboard-container">
      ...
      {/* ✅ DYNAMIC NAVBAR */}
      <StudentNavbar activeCategory="examination" />
