...
curl.exe -s --max-time 3 http://127.0.0.1:5000 >nul 2>&1
if errorlevel 1 (
    echo  [AUTO] Backend Server not responding on Port 5000. Restarting...
    ...
    echo  [OK]   Backend Server    : HEALTHY and RUNNING on Port 5000
)
